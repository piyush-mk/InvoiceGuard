...
"""
FastAPI application for the Invoice Guard Environment.

This module creates an HTTP server that exposes the InvoiceGuardEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m invoice_guard.server.app
    ...
    multiple workers:
        uvicorn invoice_guard.server.app:app --workers 4
    """
    import uvicorn
